...
//go:generate minimock -i github.com/markgenuine/auth/internal/service.AuthService -o auth_service_minimock.go -n AuthServiceMock -p mocks
...
func (mmCreate *mAuthServiceMockCreate) Expect(ctx context.Context, user *model.UserCreate) *mAuthServiceMockCreate {
...
func (mmCreate *mAuthServiceMockCreate) Inspect(f func(ctx context.Context, user *model.UserCreate)) *mAuthServiceMockCreate {
...
func (mmCreate *mAuthServiceMockCreate) Set(f func(ctx context.Context, user *model.UserCreate) (i1 int64, err error)) *AuthServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mAuthServiceMockCreate) When(ctx context.Context, user *model.UserCreate) *AuthServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("AuthServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *AuthServiceMock) Create(ctx context.Context, user *model.UserCreate) (i1 int64, err error) {
...
func (mmUpdate *mAuthServiceMockUpdate) Expect(ctx context.Context, user *model.UserUpdate) *mAuthServiceMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &AuthServiceMockUpdateParams{ctx, user}
...
func (mmUpdate *mAuthServiceMockUpdate) Inspect(f func(ctx context.Context, user *model.UserUpdate)) *mAuthServiceMockUpdate {
...
func (mmUpdate *mAuthServiceMockUpdate) Set(f func(ctx context.Context, user *model.UserUpdate) (err error)) *AuthServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mAuthServiceMockUpdate) When(ctx context.Context, user *model.UserUpdate) *AuthServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthServiceMock.Update mock is already set by Set")
	}
	...
	expectation := &AuthServiceMockUpdateExpectation{
		mock:   mmUpdate.mock,
		params: &AuthServiceMockUpdateParams{ctx, user},
	}
...
func (mmUpdate *AuthServiceMock) Update(ctx context.Context, user *model.UserUpdate) (err error) {
	...
	mm_params := AuthServiceMockUpdateParams{ctx, user}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := AuthServiceMockUpdateParams{ctx, user}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	mmUpdate.t.Fatalf("Unexpected call to AuthServiceMock.Update. %v %v", ctx, user)
	return
}
